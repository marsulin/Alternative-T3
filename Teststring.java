...
public class Teststring {
    public static void main(String[] args) throws Exception{
        ...
        if(argument[0].trim().replaceAll(" ","").length() > 10) throw new Exception("1st operand exceed length !");
        if(argument[1].trim().replaceAll(" ","").length() > 10) throw new Exception("2nd operand exceed length !");
